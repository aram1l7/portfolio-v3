export const jobHistory = [
  ...
  {
    id: 4,
    position: "Full Stack Develoepr",
    company: "Itsoft",
    time: "11/2022 - Present",
    type: "Contract",
    location: "Remote",
    description:
      "Working on a big data analytics app as a full stack developer, implementing user authentication with JWT, building new frontend and backend features such as CRUD,spam management, mailing, reset password, etc.",
  },
];
